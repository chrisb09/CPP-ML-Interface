...
inline std::vector<std::string> get_constructor_signatures(const std::string& class_name) {
    ...
    if (class_name == "MLCouplingProviderPhydll") {
        signatures.push_back("MLCouplingProviderPhydll(std::string model_file, std::string backend = \"TORCH\", std::string device = \"GPU\")");
        return signatures;
    }
...
MLCouplingProvider<In, Out>* create_instance_mlcouplingprovider(const std::string &class_name, const std::unordered_map<std::string, std::pair<int, void*>>& parameter) {
 ...
 MLCouplingProviderAixelerator with parameters: " << "model_file=" << config_param_cast<std::string>(parameter.at("model_file")) << ", ""batchsize=" << (parameter.find("batchsize") != parameter.end() ? config_param_cast<int>(parameter.at("batchsize")) : (int)1) << ", ""app_comm=<" << (parameter.find("app_comm") != parameter.end() ? "provided" : "default") << ">" << ", ""enable_hybrid=" << (parameter.find("enable_hybrid") != parameter.end() ? config_param_cast<bool>(parameter.at("enable_hybrid")) : (bool)false) << ", ""host_fraction=<" << (parameter.find("host_fraction") != parameter.end() ? "provided" : "default") << ">" << std::endl;
        ...
        // Parameters: std::string model_file, std::string backend = "TORCH", std::string device = "GPU"
        if (parameter.size() >= 1 && parameter.size() <= 3) {
            try {
                std::ostringstream create_log_stream;
                create_log_stream << "Creating instance of 
                logging::debug(create_log_stream.str());
 MLCouplingProviderPhydll with parameters: " << "model_file=" << config_param_cast<std::string>(parameter.at("model_file")) << ", ""backend=" << (parameter.find("backend") != parameter.end() ? config_param_cast<std::string>(parameter.at("backend")) : (std::string)"TORCH") << ", ""device=" << (parameter.find("device") != parameter.end() ? config_param_cast<std::string>(parameter.at("device")) : (std::string)"GPU") << std::endl;
                return new MLCouplingProviderPhydll<In, Out>(config_param_cast<std::string>(parameter.at("model_file")), parameter.find("backend") != parameter.end() ? config_param_cast<std::string>(parameter.at("backend")) : (std::string)"TORCH", parameter.find("device") != parameter.end() ? config_param_cast<std::string>(parameter.at("device")) : (std::string)"GPU");
            } catch (...) {
                // Handle exceptions if necessary
            }
        }
 ...
 MLCouplingProviderSmartsim with parameters: " << "device=" << config_param_cast<std::string>(parameter.at("device")) << ", ""model_backend=" << config_param_cast<std::string>(parameter.at("model_backend")) << ", ""model_path=" << config_param_cast<std::string>(parameter.at("model_path")) << ", ""model_name=" << (parameter.find("model_name") != parameter.end() ? config_param_cast<std::string>(parameter.at("model_name")) : (std::string)"model") << ", ""host=" << (parameter.find("host") != parameter.end() ? config_param_cast<std::string>(parameter.at("host")) : (std::string)"localhost") << ", ""port=" << (parameter.find("port") != parameter.end() ? config_param_cast<int>(parameter.at("port")) : (int)6379) << ", ""nodes=" << (parameter.find("nodes") != parameter.end() ? config_param_cast<int>(parameter.at("nodes")) : (int)1) << ", ""num_gpus=" << (parameter.find("num_gpus") != parameter.end() ? config_param_cast<int>(parameter.at("num_gpus")) : (int)0) << ", ""first_gpu=" << (parameter.find("first_gpu") != parameter.end() ? config_param_cast<int>(parameter.at("first_gpu")) : (int)0) << ", ""batch_size=" << (parameter.find("batch_size") != parameter.end() ? config_param_cast<int>(parameter.at("batch_size")) : (int)0) << ", ""min_batch_size=" << (parameter.find("min_batch_size") != parameter.end() ? config_param_cast<int>(parameter.at("min_batch_size")) : (int)0) << ", ""min_batch_timeout=" << (parameter.find("min_batch_timeout") != parameter.end() ? config_param_cast<int>(parameter.at("min_batch_timeout")) : (int)0) << ", ""tf_input_labels=<" << (parameter.find("tf_input_labels") != parameter.end() ? "provided" : "default") << ">" << ", ""tf_output_labels=<" << (parameter.find("tf_output_labels") != parameter.end() ? "provided" : "default") << ">" << std::endl;
        ...
        if (parameter.size() >= 3 && parameter.size() <= 14) {
            try {
                ...
                create_log_stream << "Creating instance of 
                logging::debug(create_log_stream.str());
 MLCouplingProviderSmartsim with parameters: " << "device=" << config_param_cast<std::string>(parameter.at("device")) << ", ""model_backend=" << config_param_cast<std::string>(parameter.at("model_backend")) << ", ""model=<provided>" << ", ""model_name=" << (parameter.find("model_name") != parameter.end() ? config_param_cast<std::string>(parameter.at("model_name")) : (std::string)"model") << ", ""host=" << (parameter.find("host") != parameter.end() ? config_param_cast<std::string>(parameter.at("host")) : (std::string)"localhost") << ", ""port=" << (parameter.find("port") != parameter.end() ? config_param_cast<int>(parameter.at("port")) : (int)6379) << ", ""nodes=" << (parameter.find("nodes") != parameter.end() ? config_param_cast<int>(parameter.at("nodes")) : (int)1) << ", ""num_gpus=" << (parameter.find("num_gpus") != parameter.end() ? config_param_cast<int>(parameter.at("num_gpus")) : (int)0) << ", ""first_gpu=" << (parameter.find("first_gpu") != parameter.end() ? config_param_cast<int>(parameter.at("first_gpu")) : (int)0) << ", ""batch_size=" << (parameter.find("batch_size") != parameter.end() ? config_param_cast<int>(parameter.at("batch_size")) : (int)0) << ", ""min_batch_size=" << (parameter.find("min_batch_size") != parameter.end() ? config_param_cast<int>(parameter.at("min_batch_size")) : (int)0) << ", ""min_batch_timeout=" << (parameter.find("min_batch_timeout") != parameter.end() ? config_param_cast<int>(parameter.at("min_batch_timeout")) : (int)0) << ", ""tf_input_labels=<" << (parameter.find("tf_input_labels") != parameter.end() ? "provided" : "default") << ">" << ", ""tf_output_labels=<" << (parameter.find("tf_output_labels") != parameter.end() ? "provided" : "default") << ">" << std::endl;
    ...
    if (resolved_class_name == "MLCouplingMinMaxNormalization") {
        ...
        if (parameter.size() == 4) {
            try {
                ...
                create_log_stream << "Creating instance of 
                logging::debug(create_log_stream.str());
 MLCouplingMinMaxNormalization with parameters: " << "input_min=<provided>" << ", ""input_max=<provided>" << ", ""output_min=<provided>" << ", ""output_max=<provided>" << std::endl;
 ...
 MLCouplingMinMaxNormalization with parameters: " << "input_data=" << reinterpret_cast<In*>(parameter.at("input_data").second) << ", ""input_data_size=" << config_param_cast<int>(parameter.at("input_data_size")) << ", ""output_data=" << reinterpret_cast<Out*>(parameter.at("output_data").second) << ", ""output_data_size=" << config_param_cast<int>(parameter.at("output_data_size")) << std::endl;
        ...
        if (parameter.size() == 2) {
            try {
                ...
                create_log_stream << "Creating instance of 
                logging::debug(create_log_stream.str());
 MLCouplingMinMaxNormalization with parameters: " << "input_data=" << (*reinterpret_cast<MLCouplingData<In>*>(parameter.at("input_data").second)) << ", ""output_data=" << (*reinterpret_cast<MLCouplingData<Out>*>(parameter.at("output_data").second)) << std::endl;
    ...
    if (resolved_class_name == "MLCouplingBehaviorDefault") {
        ...
        if (parameter.size() == 0) {
            try {
                ...
                create_log_stream << "Creating instance of 
                logging::debug(create_log_stream.str());
 MLCouplingBehaviorDefault with parameters: " << std::endl;
